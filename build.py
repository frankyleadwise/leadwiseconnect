    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:6rem;align-items:start" class="contact-outer">
      ...
      <div class="reveal">
        <div id="form-card" class="card">
          ...
          <form id="audit-form"><!-- submission handled by _scripts.js -> GHL webhook -->
            ...
            <label class="fg" style="display:flex;align-items:flex-start;gap:.6rem;cursor:pointer"><input type="checkbox" name="sms_consent" value="true" style="margin-top:.25rem;flex:0 0 auto;width:auto;accent-color:#E8A020"/><span style="font-size:.75rem;color:var(--text3);line-height:1.6">I agree to receive text messages from LeadWise Connect about my audit request and related follow-up. Msg &amp; data rates may apply, frequency varies. Reply STOP to opt out or HELP for help. Consent is not a condition of purchase. See our <a href="/privacy.html" style="color:#E8A020">Privacy Policy</a> &amp; <a href="/terms.html" style="color:#E8A020">Terms</a>.</span></label>
