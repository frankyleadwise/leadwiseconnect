...
trades = [
    {
        ...
        "specific_features": [
            ...
            ("Review generation system", "We took one HVAC client from 10 to 34 Google reviews in 6 months with automated post-job follow-up — they're at 52 and still climbing. More reviews means higher map pack rankings."),
        ...
        "why_items": [
            ...
            ("We built the North East HVAC playbook", "Our Tampa Bay HVAC client went from a generic GHL page to a 30+ page SEO site with 20+ city pages, a 5.0 star rating, and 52 Google reviews. That system is now our standard."),
